...
<header class="bg-dark basic-container">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1><i class="fa fa-edit mr-2"></i>Manage Categories</h1>
            </div>
        </div>
    </div>
</header>
...
<section class="container py-3">
    <div class="row">
        ...
        <div class="offset-lg-1 col-lg-10">
            <!----------------------error message for submit of categories--------------------------------->
            <?php
            ...
            ?>
            <!----------------------error message for delete of categories--------------------------------->
            <form action="database/categories.inc.php" method="POST">
                <div class="card bg-secondary card-container">
                    <div class="card-header">
                        <h1>Add New Categories</h1>
                    </div>
                    <div class="card-body text-white bg-dark">
                        <label for="ctitle" class="card-text">Categories Title: </label>
                        <input type="text" name="categoriestitle" placeholder="Type title here" id="ctitle">
                    ...
                    <tbody>
                        ...
                        if (!mysqli_stmt_prepare($stmt, $sql)) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td>' . $row['datetime'] . '</td>
                                <td>' . $row['author'] . '</td>
                                <td><a href="database/deletecategories.php?id=' . $row['id'] . '" class="btn btn-danger mb-2">Delete</a>
                                </td>
                            </tr>';
                                $increment++;
                            }
